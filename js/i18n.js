...
window.I18N = {
  zh: {
    ...
    sr_all_e: "全部（{n} 人有報工）", sr_a4: "A4 列印",
    ...
    pg_last: "↑ 虛線框是上次報的 {n}%，請點今天做到哪",
    pg_required: "請點選本站完成度（做到幾成）",
    admin_os: "委外追蹤", refresh: "重新整理",
    os_hint: "委外站與廠商從 ERP 加工製程單自動帶入；只有「送出」「回廠」要人登記，誰送誰按。",
    os_tab_out: "🔴 在外面", os_tab_todo: "📦 待送出", os_tab_back: "✅ 已回廠",
    os_k_out: "在外未回（張）", os_k_late: "已逾期未回", os_k_todo: "待送出", os_k_back: "已回廠",
    os_empty: "目前沒有資料", os_seq: "代碼", os_vendor: "廠商", os_prev: "前一站",
    os_sent_at: "送出日期", os_sent_qty: "送出數量", os_due_back: "預計回廠日",
    os_back_at: "回廠日期", os_back_qty: "回廠數量", os_back_ng: "不良數量（沒有填 0）",
    os_days: "在外天數", os_day: "天", os_late: "逾期 {n} 天",
    os_sent_by: "送出登記", os_back_by: "回廠登記", os_assigned: "指派給",
    os_qty_pair: "送出/回廠", os_vendor_yield: "廠商良率",
    os_do_send: "登記送出", os_do_back: "登記回廠", os_do_assign: "指派送貨",
    os_pick_emp: "指派給誰去送", os_need_date: "請填日期",
    os_st_out: "在外 {n} 天", os_st_back: "已回廠",
    nt_os_ready: "{wo} 前一站完成，可送 {v}", nt_os_assigned: "請送 {wo} 到 {v}",
  ...
  vi: {
    ...
    sr_all_e: "Tất cả ({n} người)", sr_a4: "In A4",
    ...
    pg_last: "↑ Khung nét đứt là {n}% lần trước, hãy bấm hôm nay làm tới đâu",
    pg_required: "Hãy chọn tiến độ công đoạn (làm được bao nhiêu)",
    admin_os: "Theo dõi gia công ngoài", refresh: "Làm mới",
    os_hint: "Công đoạn và nhà thầu lấy tự động từ ERP; chỉ cần đăng ký «gửi đi» và «nhận về».",
    os_tab_out: "🔴 Đang ở ngoài", os_tab_todo: "📦 Chờ gửi", os_tab_back: "✅ Đã nhận về",
    os_k_out: "Đang ở ngoài", os_k_late: "Quá hạn chưa về", os_k_todo: "Chờ gửi", os_k_back: "Đã nhận về",
    os_empty: "Chưa có dữ liệu", os_seq: "Mã", os_vendor: "Nhà thầu", os_prev: "Công đoạn trước",
    os_sent_at: "Ngày gửi", os_sent_qty: "SL gửi", os_due_back: "Dự kiến về",
    os_back_at: "Ngày nhận về", os_back_qty: "SL nhận về", os_back_ng: "Số phế (không có ghi 0)",
    os_days: "Số ngày ở ngoài", os_day: "ngày", os_late: "Quá hạn {n} ngày",
    os_sent_by: "Người gửi", os_back_by: "Người nhận", os_assigned: "Giao cho",
    os_qty_pair: "Gửi/Về", os_vendor_yield: "Tỷ lệ đạt NT",
    os_do_send: "Đăng ký gửi", os_do_back: "Đăng ký nhận về", os_do_assign: "Giao người gửi",
    os_pick_emp: "Giao cho ai đi gửi", os_need_date: "Vui lòng nhập ngày",
    os_st_out: "Ở ngoài {n} ngày", os_st_back: "Đã về",
    nt_os_ready: "{wo} xong công đoạn trước, có thể gửi {v}", nt_os_assigned: "Vui lòng gửi {wo} đến {v}",
