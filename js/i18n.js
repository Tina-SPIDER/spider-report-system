...
window.I18N = {
  zh: {
    ...
    sp_st_score: "本站分數", sp_multi_tip: "此站在製程中出現多次，比例只設一次、各道共用",
  ...
  vi: {
    ...
    sp_st_score: "Điểm CĐ này", sp_multi_tip: "Công đoạn xuất hiện nhiều lần trong quy trình, tỷ lệ chỉ đặt một lần",
