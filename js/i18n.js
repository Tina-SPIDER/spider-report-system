...
window.I18N = {
  zh: {
    ...
    as_st_none: "未開始", as_st_doing: "進行中", as_st_done: "已完成",    as_est: "預估", as_est_per: "預估工時/顆(分)", as_est_total: "全單預估(分)", as_est_src: "來源",
  ...
  vi: {
    ...
    as_st_none: "Chưa bắt đầu", as_st_doing: "Đang làm", as_st_done: "Đã xong",    as_est: "Ước tính", as_est_per: "Giờ ước tính/cái (phút)", as_est_total: "Cả đơn (phút)", as_est_src: "Nguồn",
