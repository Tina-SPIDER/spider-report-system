...
window.I18N = {
  zh: {
    ...
    mc_by_machine: "依機台", mc_by_station: "依工站",
    ...
    mc_note: "⚠️ <b>性能P%、OEE%、停機主因目前算不出來</b>：性能P% 需要「每顆標準工時」（ERP 的製程時間有 94% 是 0），停機主因需要暫停時記錄原因（系統目前沒有這個欄位）。稼動率A%＝實際÷計畫、品質Q%＝良品÷總產出，這兩項是實際資料算出來的。",
  ...
  vi: {
    ...
    mc_by_machine: "Theo máy", mc_by_station: "Theo công đoạn",
    ...
    mc_note: "⚠️ <b>Hiệu suất P%, OEE%, nguyên nhân dừng máy hiện chưa tính được</b>: P% cần giờ chuẩn mỗi cái (94% dữ liệu ERP là 0), nguyên nhân dừng cần ghi lý do khi tạm dừng (hệ thống chưa có ô này). A% = thực tế ÷ kế hoạch, Q% = hàng đạt ÷ tổng SL — hai chỉ số này tính từ dữ liệu thật.",
